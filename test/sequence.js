...
exports['execute sync function in sequence with success in sequence'] = function (test) {
    test.async();
...
exports['execute two sync function in sequence with success in sequence'] = function (test) {
    test.async();
...
exports['execute async function in sequence with success in sequence'] = function (test) {
    test.async();
...
exports['execute two async function in sequence with success in sequence'] = function (test) {
    test.async();
